<template>
	<view class="main-container">
		...
		<view class="image-grid" v-if="diary.images.length > 0">
			<a v-for="(imageUrl, index) in displayedImages" :key="index" :href="imageUrl" class="grid-item"
				@longpress="showDeleteButton(index)">
				<image :src="imageUrl" mode="aspectFit" class="diaryimage"></image>
			</a>
		</view>
	</view>
</template>
