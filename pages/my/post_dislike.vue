		...
		methods: {
			...
			async get_all_post() {
				...
				return new Promise((resolve, reject) => {
					uni.request({
						url: `https://vx.mikumikumi.xyz/api/v1/forum/posts/getDislikedPosts/?sort_by=${this.sort}&offset=0&limit=20`,
						method: 'GET',
						header: {
			...
			async get_other_post() {
				...
				return new Promise((resolve, reject) => {
					...
					uni.request({
						url: `https://vx.mikumikumi.xyz/api/v1/forum/posts/getDislikedPosts/?sort_by=${this.sort}&limit=20&offset=${a}`,
